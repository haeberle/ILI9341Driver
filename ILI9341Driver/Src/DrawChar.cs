...
namespace ILI9341Driver
{
    ...
    {
        public void DrawChar(int x, int y, Color565 color, FontCharacter character, bool isDebug = false)
        {
            lock (this)
            {
        ...
        public void DrawChar(int x, int y, Color565 foreground, Color565 background, FontCharacter character, bool isDebug = false)
        {
            lock (this)
            {
                SetWindow(x, x + character.Width - 1, y, y + character.Height - 1);
